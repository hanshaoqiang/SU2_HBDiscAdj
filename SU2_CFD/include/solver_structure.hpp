...
//	virtual void SetSecondary_Limiter_MPI(CGeometry *geometry, CConfig *config);
    ...
    /*!
     * \brief A virtual member.
     * \param[in] val_Total_Avg_CDrag - Value of the total drag coefficient averaged over all zones.
     */
  ...
  /*!
    ...
    /*!
     * \brief A virtual member.
     * \return Value of the averaged drag coefficient over all zones for spectral method (inviscid + viscous contribution).
     */
...
protected:
  ...
  *Exhaust_Temperature,	/*!< \brief Fan face mach number for each boundary. */
  ...
  Total_Avg_CDrag, /*!< \brief Total drag coefficient for all the boundaries averaged over zones for spectral method */

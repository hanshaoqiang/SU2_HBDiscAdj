...
public:
  ...
  virtual void Postprocess();
    ...
    /* For Multi Zone Discrete Adjoint */
    
    virtual void Preprocess_1(COutput *output,
                              CIntegration ***integration_container,
                              CGeometry ***geometry_container,
                              CSolver ****solver_container,
                              CNumerics *****numerics_container,
    ...
    virtual void Preprocess_output(COutput *output,
                                   CIntegration ***integration_container,
                                   CGeometry ***geometry_container,
                                   CSolver ****solver_container,
                                   CNumerics *****numerics_container,
    ...
    virtual void ExtractAdjoint(COutput *output,
                                CIntegration ***integration_container,
                                CGeometry ***geometry_container,
                                CSolver ****solver_container,
                                CNumerics *****numerics_container,
    ...
    virtual void PrepareForRecording(COutput *output,
                                     CIntegration ***integration_container,
                                     CGeometry ***geometry_container,
                                     CSolver ****solver_container,
                                     CNumerics *****numerics_container,
    ...
    virtual void RunMeanFlowIteration(COutput *output,
                                      CIntegration ***integration_container,
                                      CGeometry ***geometry_container,
                                      CSolver ****solver_container,
                                      CNumerics *****numerics_container,
    ...
    virtual void SetRecordingStatus(unsigned short val_iZone,
                                    unsigned short kind_recording);
...
/*!
 * \class CDiscAdjMultiZoneMeanFlowIteration
 * \brief Class for driving an iteration of the Multi Zone discrete adjoint mean flow system.
 * \author Sravya Nimmagadda
 */
class CDiscAdjMultiZoneMeanFlowIteration : public CIteration {
...
public:
     ...
     * \param[in] config - Definition of the particular problem.
     */
    CDiscAdjMultiZoneMeanFlowIteration(CConfig *config);
    
    /*!
     * \brief Destructor of the class.
     */
    ~CDiscAdjMultiZoneMeanFlowIteration(void);
    
    /*!
     * \brief Preprocessing to prepare for an iteration of the physics.- SetGridMovement - Part of Preprocess method in CDiscAdjMeanFlowIteration
     * \param[in] ??? - Description here.
     */
    void Preprocess_1(COutput *output,
                    CIntegration ***integration_container,
                    CGeometry ***geometry_container,
                    CSolver ****solver_container,
                    CNumerics *****numerics_container,
    ...
    /*!
     * \brief Log Residual output to screen during Preprocess -- Part of Preprocess method in CDiscAdjMeanFlowIteration
     * \param[in] ??? - Description here.
     */
     void Preprocess_output(COutput *output,
                    CIntegration ***integration_container,
                    CGeometry ***geometry_container,
                    CSolver ****solver_container,
                    CNumerics *****numerics_container,
    ...
    /*!
     * \brief Extracting Adjoints after computing it - Part of Iter method in CDiscAdjMeanFlowIteration
     * \param[in] output - Pointer to the COutput class.
     * \param[in] integration_container - Container vector with all the integration methods.
     * \param[in] geometry_container - Geometrical definition of the problem.
     * \param[in] solver_container - Container vector with all the solutions.
     ...
     * \param[in] FFDBox - FFD FFDBoxes of the problem.
     */
    void ExtractAdjoint(COutput *output,
                 CIntegration ***integration_container,
                 CGeometry ***geometry_container,
                 CSolver ****solver_container,
                 CNumerics *****numerics_container,
    ...
    /*!
     * \brief Set Recording fro solver system before AD StartRecording - - Part of SetRecording method in CDiscAdjMeanFlowIteration
     * \param[in] output - Pointer to the COutput class.
     * \param[in] integration_container - Container vector with all the integration methods.
     * \param[in] geometry_container - Geometrical definition of the problem.
     * \param[in] solver_container - Container vector with all the solutions.
     ...
     * \param[in] kind_recording - The kind of recording (geometry or flow).
     */
    void PrepareForRecording(COutput *output,
                      CIntegration ***integration_container,
                      CGeometry ***geometry_container,
                      CSolver ****solver_container,
                      CNumerics *****numerics_container,
    ...
    /*!
     * \brief Run one Mean flow Iteration for AD Recording - Part of SetRecording method in CDiscAdjMeanFlowIteration
     * \param[in] output - Pointer to the COutput class.
     * \param[in] integration_container - Container vector with all the integration methods.
     * \param[in] geometry_container - Geometrical definition of the problem.
     * \param[in] solver_container - Container vector with all the solutions.
     ...
     * \param[in] kind_recording - The kind of recording (geometry or flow).
     */
    void RunMeanFlowIteration(COutput *output,
                             CIntegration ***integration_container,
                             CGeometry ***geometry_container,
                             CSolver ****solver_container,
                             CNumerics *****numerics_container,
    ...
    /*!
     * \brief Sets Recording status - Part of SetRecording method in CDiscAdjMeanFlowIteration
     * \param[in] val_iZone - Index of the zone.
     * \param[in] kind_recording - The kind of recording (geometry or flow).
     */
    void SetRecordingStatus(unsigned short val_iZone,
                            unsigned short kind_recording);

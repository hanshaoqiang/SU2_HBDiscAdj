...
/*!
 * \class CSpectralDiscAdjDriver
 * \brief Class for driving an iteration of a spectral method discrete adjoint problem using multiple zones.
 * \author Sravya Nimmagadda
 */
class CSpectralDiscAdjDriver : public CDriver {
    CIteration** meanflow_iteration;
...
public:
     ...
     * \param[in] val_nZone - Total number of zones.
     */
    CSpectralDiscAdjDriver(CIteration **iteration_container,
                    CSolver ****solver_container,
                    CGeometry ***geometry_container,
                    CIntegration ***integration_container,
                    CNumerics *****numerics_container,
     ...
     * \brief Destructor of the class.
     */
    ~CSpectralDiscAdjDriver(void);
    
    /*!
     * \brief Run a single iteration of a spectral method discrete adjoint problem.
     * \param[in] iteration_container - Container vector with all the iteration methods.
     * \param[in] output - Pointer to the COutput class.
     * \param[in] integration_container - Container vector with all the integration methods.
     * \param[in] geometry_container - Geometrical definition of the problem.
    ...
    /*!
     * \brief Recording for the Discrete Adjoint problem
     * \param[in] iteration_container - Container vector with all the iteration methods.
     * \param[in] output - Pointer to the COutput class.
     * \param[in] integration_container - Container vector with all the integration methods.
     * \param[in] geometry_container - Geometrical definition of the problem.

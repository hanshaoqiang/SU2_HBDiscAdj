...
void CIteration::Preprocess_1(COutput *output,
                              CIntegration ***integration_container,
                              CGeometry ***geometry_container,
                              CSolver ****solver_container,
                              CNumerics *****numerics_container,
                              ...
                              CFreeFormDefBox*** FFDBox,
                              unsigned short val_iZone) { }
void CIteration::Preprocess_output(COutput *output,
                                   CIntegration ***integration_container,
                                   CGeometry ***geometry_container,
                                   CSolver ****solver_container,
                                   CNumerics *****numerics_container,
                                   ...
                                   CFreeFormDefBox*** FFDBox,
                                   unsigned short val_iZone)    { }
void CIteration::InitializeAdjoint(CSolver ****solver_container,
                                   CGeometry ***geometry_container,
                                   CConfig **config_container,
                                   unsigned short iZone)    { }
void CIteration::ExtractAdjoint(COutput *output,
                                CIntegration ***integration_container,
                                CGeometry ***geometry_container,
                                CSolver ****solver_container,
                                CNumerics *****numerics_container,
                                ...
                                CFreeFormDefBox*** FFDBox,
                                unsigned short val_iZone)   { }
void CIteration::PrepareForRecording(COutput *output,
                                     CIntegration ***integration_container,
                                     CGeometry ***geometry_container,
                                     CSolver ****solver_container,
                                     CNumerics *****numerics_container,
...
void CIteration::RunMeanFlowIteration(COutput *output,
                                      CIntegration ***integration_container,
                                      CGeometry ***geometry_container,
                                      CSolver ****solver_container,
                                      CNumerics *****numerics_container,
                                      ...
                                      unsigned short val_iZone,
                                      unsigned short kind_recording)    { }
void CIteration::SetRecordingStatus(unsigned short val_iZone,
                                    unsigned short kind_recording)  { }
void CIteration::RegisterInput(CSolver ****solver_container,
                               CGeometry ***geometry_container,
                               CConfig **config_container,
                               unsigned short iZone,
                               unsigned short kind_recording)   { }
void CIteration::RegisterOutput(CSolver ****solver_container,
                                CGeometry ***geometry_container,
                                CConfig **config_container,
                                unsigned short iZone)   { }
...
>>>>>>> c96a1f6688f188e5fd04fc6c6c23bb14b3172088
  ...
  if (spectral_method)
     SetSpectralMethod(geometry_container, solver_container, config_container, val_iZone);
...
void CMeanFlowIteration::SetSpectralMethod(CGeometry ***geometry_container, CSolver ****solver_container,
                                        CConfig **config_container, unsigned short iZone) {
  //cout << "Inside SetSpectralMethod - iteration_structure" << endl;
    int rank = MASTER_NODE;
#ifdef HAVE_MPI
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
#endif
    ...
    unsigned short nZone = config_container[ZONE_0]->GetnTimeInstances();
...
void CMeanFlowIteration::ComputeTimeSpectral_Operator(su2double **D, su2double period) {
...
void CMeanFlowIteration::ComputeHarmonicBalance_Operator(su2double **D, su2double *Omega_HB, su2double period, unsigned short nZone) {
...
<<<<<<< HEAD
  cout << " ***************** In Single zone Discrete AD Solver " << endl;
=======
...
<<<<<<< HEAD
  ...
  if(config_container[ZONE_0]->GetUnsteady_Simulation() == SPECTRAL_METHOD)
    meanflow_iteration->SetSpectralMethod(geometry_container, solver_container, config_container, val_iZone%nZone);
...
<<<<<<< HEAD
/*--- Multi Zone Discrete Adjoint Solver ---*/

CDiscAdjMultiZoneMeanFlowIteration::CDiscAdjMultiZoneMeanFlowIteration(CConfig *config) : CIteration(config), CurrentRecording(NONE){
...
CDiscAdjMultiZoneMeanFlowIteration::~CDiscAdjMultiZoneMeanFlowIteration(void) { }
void CDiscAdjMultiZoneMeanFlowIteration::Preprocess_1(COutput *output,
                                           CIntegration ***integration_container,
                                           CGeometry ***geometry_container,
                                           CSolver ****solver_container,
                                           CNumerics *****numerics_container,
...
void CDiscAdjMultiZoneMeanFlowIteration::Preprocess_output(COutput *output,
                                             CIntegration ***integration_container,
                                             CGeometry ***geometry_container,
                                             CSolver ****solver_container,
                                             CNumerics *****numerics_container,
    ...
    if (CurrentRecording != FLOW_VARIABLES){
        ...
        /*--- Print residuals after SetRecording in the first iteration ---*/
...
void CDiscAdjMultiZoneMeanFlowIteration::ExtractAdjoint(COutput *output,
                                        CIntegration ***integration_container,
                                        CGeometry ***geometry_container,
                                        CSolver ****solver_container,
                                        CNumerics *****numerics_container,
...
void CDiscAdjMultiZoneMeanFlowIteration::PrepareForRecording(COutput *output,
                                             CIntegration ***integration_container,
                                             CGeometry ***geometry_container,
                                             CSolver ****solver_container,
                                             CNumerics *****numerics_container,
...
void CDiscAdjMultiZoneMeanFlowIteration::RunMeanFlowIteration(COutput *output,
                                                             CIntegration ***integration_container,
                                                             CGeometry ***geometry_container,
                                                             CSolver ****solver_container,
                                                             CNumerics *****numerics_container,
    ...
    /*if(config_container[ZONE_0]->GetUnsteady_Simulation() == SPECTRAL_METHOD)
      meanflow_iteration->SetSpectralMethod(geometry_container, solver_container, config_container, val_iZone);*/
...
void CDiscAdjMultiZoneMeanFlowIteration::SetRecordingStatus(unsigned short val_iZone,
                                                            unsigned short kind_recording) {
    /*--- Set the recording status ---*/
    CurrentRecording = kind_recording;
}
...
void CDiscAdjMultiZoneMeanFlowIteration::RegisterInput(CSolver ****solver_container, CGeometry ***geometry_container, CConfig **config_container, unsigned short iZone, unsigned short kind_recording){
...
void CDiscAdjMultiZoneMeanFlowIteration::SetDependencies(CSolver ****solver_container, CGeometry ***geometry_container, CConfig **config_container, unsigned short iZone, unsigned short kind_recording){
...
void CDiscAdjMultiZoneMeanFlowIteration::RegisterOutput(CSolver ****solver_container, CGeometry ***geometry_container, CConfig **config_container, unsigned short iZone){
...
void CDiscAdjMultiZoneMeanFlowIteration::InitializeAdjoint(CSolver ****solver_container, CGeometry ***geometry_container, CConfig **config_container, unsigned short iZone){
...
void CDiscAdjMultiZoneMeanFlowIteration::Update(COutput *output,
                                       CIntegration ***integration_container,
                                       CGeometry ***geometry_container,
                                       CSolver ****solver_container,
                                       CNumerics *****numerics_container,
                                       ...
                                       CFreeFormDefBox*** FFDBox,
                                       unsigned short val_iZone)      { }
void CDiscAdjMultiZoneMeanFlowIteration::Monitor()     { }
void CDiscAdjMultiZoneMeanFlowIteration::Output()      { }
void CDiscAdjMultiZoneMeanFlowIteration::Postprocess() { }
